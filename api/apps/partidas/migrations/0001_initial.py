    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Creación')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='Fecha de Modificación')),
                ('timeIni', models.DateTimeField(verbose_name='Hora de inicio de la pregunta')),
                ('timeFin', models.DateTimeField(verbose_name='Hora de finalización de la pregunta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historico', models.SmallIntegerField(verbose_name='Histórico')),
                ('espaciado', models.SmallIntegerField(verbose_name='Espaciado')),
        ...
        migrations.CreateModel(
            name='UserComp',
            fields=[
                ('partida', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='participacion', serialize=False, to='partidas.partida', verbose_name='Partida')),
